...
const name = 'addcoins';
const desc = 'adds demon coins to user (ADMINS ONLY)';
const usage =  `${prefix}addcoins <amount_of_coins> for you or add mention to give demon coins to another user (ADMINS ONLY)`;
