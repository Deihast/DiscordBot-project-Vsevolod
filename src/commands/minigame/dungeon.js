...
module.exports = {
    name: 'dungeon',
    desc: 'enter the dungeon to get reward (exp, rubies, demon coins)',
    usage: `${prefix}dungeon solo/group`,
    ...
    async run (client, message, args) {
        ...
        const filter = (interaction) => {
            if (interaction.user.id !== players[0].id) return true;
            return interaction.reply('You have already joined the group!');
        }
